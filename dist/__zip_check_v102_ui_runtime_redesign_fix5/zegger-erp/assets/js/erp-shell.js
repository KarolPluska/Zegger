(function () {
  ...
  function renderSidebar() {
    ...
    html.push('<div class="zerp-sidebar-head">Nawigacja</div>');

    active.forEach(function (mod) {
      html.push(
        '<button class="zerp-sidebar-item" data-module="' + escapeHtml(mod.id) + '">' +
    ...
    if (future.length) {
      html.push('<div class="zerp-sidebar-head is-sub">W produkcji</div>');
      future.forEach(function (mod) {
        html.push('<button class="zerp-sidebar-item is-disabled" data-disabled="1" title="W produkcji"><span class="zerp-sidebar-item-label">' + escapeHtml(mod.label) + '</span></button>');
      });
    }
  ...
  function moduleDashboard() {
    ...
    wrap.className = 'zerp-workspace zerp-workspace-dashboard';
    wrap.innerHTML = '' +
      '<section class="zerp-launcher-hero">' +
      '  <div class="zerp-launcher-hero-copy">' +
      '    <p class="zerp-kicker">Zegger ERP</p>' +
      '    <h2>Wybierz moduł roboczy</h2>' +
      '    <p class="zerp-launcher-lead">Pracuj na modułach jak w jednej aplikacji okienkowej - szybki dostęp, czytelne priorytety i mniej przełączania kontekstu.</p>' +
      '  </div>' +
    ...
    (state.modules.active || []).forEach(function (mod) {
      ...
      tile.innerHTML = '' +
        ...
        '  <span class="zerp-launcher-chip">Moduł</span>' +
        '</div>' +
        ...
        '<div class="zerp-launcher-tile-cta">Otwórz moduł</div>';
    ...
    if (future.length) {
      ...
      title.textContent = 'Moduły w produkcji';
      ...
      future.forEach(function (mod) {
        ...
        tile.innerHTML = '' +
          '<div class="zerp-launcher-tile-top"><span class="zerp-launcher-chip">W produkcji</span></div>' +
          '<div class="zerp-launcher-tile-title">' + escapeHtml(mod.label) + '</div>' +
          '<div class="zerp-launcher-tile-desc">Moduł jest przygotowywany do uruchomienia.</div>';
